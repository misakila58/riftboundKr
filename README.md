...
3. 방장: **[초대 코드 만들기]** → 코드를 카톡/디스코드로 전송
4. 상대: 코드를 붙여넣고 **[응답 코드 만들기]** → 응답 코드를 방장에게 회신
5. 방장: 응답 코드를 붙여넣고 **[연결하기]** → 자동으로 게임 시작!

> WebRTC 직접 연결(P2P) 방식입니다. 대부분의 가정 환경에서 동작하지만, 일부
> 사내망/특수 공유기에서는 연결이 안 될 수 있습니다 — 그 경우 방법 B를 쓰세요.
