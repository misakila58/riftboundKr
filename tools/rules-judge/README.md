...
| `data/riftjudge.jsonl` | 커뮤니티 판정 Q&A 12,420건 (verified 11,365 · deprecated 1,053), 2026-09-17 수집 | https://app.riftjudge.com (공개 API) |
...
- 룰북은 2026-07-16판(최신), 에라타 2026-01-14, 밴 리스트 2026-09-18(`data/banlist-2026-09-18.md`), 판정은 2026-09-17 수집분입니다. 갱신 방법은 `RIFTBOUND_JUDGE.md` 마지막 항목 참고.
