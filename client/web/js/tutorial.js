...
const TUT_P1 = {
  ...
  hand:[211,219,210,219],                       // 211(2⚔, 맹공 없음)로 공격 → 상호 전멸 수업
...
function tutSteps(){
  ...
  { kind:'info', title:'🔄 턴 구조 (A-B-C-D)',
    ...
    <b>B 시작</b> — 시작 효과 발동 + <b>유지 득점</b>: 통제 중인 전장마다 1점!<br>
  ...
  { kind:'task', title:'🛡 방어 결전! 패스하면 전투가 벌어집니다',
    text:`봇이 유닛을 당신의 전장에 보냈습니다 — 이번엔 <b>전투가 있는 결전</b>입니다.<br>
    지금 [행동] 주문으로 요격할 수도 있지만, 일단 <b>[패스]</b>해서 전투를 구경해봅시다.<br><br>
    <b>전투 규칙</b>: 양측 유닛의 <b>위력(⚔) 합계</b>만큼 서로에게 피해를 배분합니다.
  ...
  { kind:'info', title:'💥 전투 결과',
    text:`양쪽 유닛이 위력 2 vs 2로 <b>동시에</b> 피해를 주고받아 함께 쓰러졌습니다.<br>
    중요한 점 — 공격측이 전멸했으므로 <b>전장 통제권은 그대로 당신</b>에게 남습니다!<br>
    (방어측이 살아남으면 공격 유닛들은 기지으로 후퇴합니다)<br><br>
