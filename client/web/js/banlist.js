...
// 아래는 그중 이 시뮬레이터 카드풀(Origins/OGN 298장)에 존재하는 10종 (2026-09-18 개정 반영).
...
//   · 110 Ekko - Recurrent(에코 - 회귀자)      — 2026-09-18 시행 (추가 턴+자기 재활용 무한 콤보)
//   · 183 Stacked Deck(조작된 덱)              — 2026-09-18 시행 (럭스 콤보·케넨 일관성)
// OGN 외 밴 카드(이 시뮬레이터에 없음): Called Shot, Draven Vanquisher(Spiritforged),
// Master Yi, Wuju Bladesman(Proving Grounds, 2v2 전용 밴).
// 공지: https://playriftbound.com/en-us/news/announcements/september-ban-list-updates-effective-september-18-2026/
// ⚠ 서버(server/server.js)의 BANNED 상수와 반드시 함께 갱신할 것.
const BANLIST = {
  region: '한국(KR) 공식',
  updated: '2026-09-18',
  source: 'https://playriftbound.com/ko-kr/rules-hub/',
  cards: [110, 168, 177, 182, 183, 276, 284, 285, 290, 292],
};
