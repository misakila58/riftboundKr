...
function renderRooms(roomsArr){
  ...
  roomsArr.forEach(r=>{
    ...
    bj.onclick=()=>{
      ...
      NET.send({t:'joinRoom', roomId:r.id, ...pay, banRule:document.getElementById('lobby-ban').checked, ver:NET.clientVersion()});
    };
    btns.appendChild(bj);
    div.appendChild(btns);
    el.appendChild(div);
...
function initLobby(){
  ...
  document.getElementById('btn-create-room').onclick=()=>{
    ...
    NET.send({t:'createRoom', ...pay, manual, banRule:ban, name:document.getElementById('lobby-room-name').value.trim(), ver:NET.clientVersion()});
  };
